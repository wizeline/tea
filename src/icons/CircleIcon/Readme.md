...
```jsx
  <div>
    ...
    <CircleIcon name="book" />book<br />
    <CircleIcon name="building" />building<br />
    <CircleIcon name="calendar" />calendar<br />
    <CircleIcon name="check" />check<br />
    <CircleIcon name="credit-card" />card<br />
    <CircleIcon name="cross" />cross<br />
    <CircleIcon name="dots-h" />dots-h<br />
    <CircleIcon name="duplicate" />duplicate<br />
    ...
    <CircleIcon name="pencil" />pencil<br />
    <CircleIcon name="people" />people<br />
    <CircleIcon name="trash" />trash<br />
  </div>
```
